 ...
 */
export function saveDomainInfoTemporarily(domain: string, domainInfo: DomainInfo): void {
  if (typeof window !== 'undefined') {
    localStorage.setItem(`pending_domain_${domain}`, JSON.stringify(domainInfo));
  }
}
 ...
 */
export async function updateDomainWithSavedInfo(domain: string): Promise<boolean> {
